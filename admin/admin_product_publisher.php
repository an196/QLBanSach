                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="namePublisher" name="namePublisher">
                                        </div>
                                        <div class="form-group">
                        ...
                        <div class="modal fade" id="modalUpdateProduct" style="margin-top: 150px;">
                            <div class="modal-dialog modal-md">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="form-group">
                                            <label for="update_idPulisher">Mã nhà xuất bản:</label>
                                            <input type="text" class="form-control" id="update_idPublisher" >
                                        </div>
                                        <div class="form-group">
                                            <label for="update_namePublisher">Tên xuất bản:</label>
                                            <input type="text" class="form-control" id="update_namePublisher">
                                        </div>
                                        <div class="form-group">
                                            <label for="update_logo">Logo:</label>
                                            <input type="text" class="form-control" id="update_logo">
                                        </div>
                                    </div>
                            ...
                            <br><br>
                              <div class="table-responsive col-md-12  d-flex flex-column">
                                    <table class="table table-bordered w-100" id="dataTable" cellspacing="0">
                                        <thead>
                                            <tr>
                                            <th class="w-10">Mã nhà xuất bản</th>
                                            <th class="w-40">Tên nhà xuất bản</th>
                                            <th class="w-40">Logo</th>
                                            <th class="w-10">Thao tác</th>
                                            </tr>
                                        </thead>
                                        <tbody id="myTable">
                                            <?php include '../admin/admin_product_publisher/dataTable.inc.php';?>
                                        </tbody>
                                    </table>
                              </div>
                            </div>
