                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="form-group">
                                            <label for="idCategory">Mã danh mục:</label>
                        ...
                        <div class="modal fade" id="modalUpdateProduct" style="margin-top: 150px;">
                            <div class="modal-dialog modal-md">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="form-group">
                                            <label for="update_idCategory">Mã danh mục:</label>
                                            <input type="text" class="form-control" id="update_idCategory" >
                                        </div>
                                        <div class="form-group">
                                            <label for="update_nameCategory">Tên danh mục:</label>
                                            <input type="text" class="form-control" id="update_nameCategory">
                                        </div>
                                    </div>
                              ...
                              <div class="table-responsive col-md-12 d-flex flex-column">
                                    <table class="table table-bordered w-100" id="dataTable" cellspacing="0">
                                        <thead>
                                            <tr>
                                            <th class="w-5">Mã</th>
                                            <th class="w-85">Tên danh mục</th>
                                            <th class="w-10">Thao tác</th>
                                            </tr>
                                        </thead>
                                        <tbody id="myTable">
                                        <?php include '../admin/admin_product_category/dataTable.inc.php';?>
                                        </tbody>
                                    </table>
                              </div>
                            </div>
